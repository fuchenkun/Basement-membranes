# install.packages()
# BiocManager::install("cofint")
# library(cofint)
library(rms)
library(ROCR)
setwd("C:\\Users\\HASEE\\Desktop\\BMs\\20.Nom")
...
head(data1)
median(as.numeric(data1[,"ITGA10"]))
...
mynom<- nomogram(mylog, fun=plogis,fun.at=c(0,0.1,0.2,0.5,0.9,1),lp=F, funlabel="Risk of IPF")
